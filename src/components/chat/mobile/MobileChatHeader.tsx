    ...
    <>
      ...
      >
        <button
          ...
          className="liquid-glass-button w-11 h-11 rounded-full flex items-center justify-center text-foreground active:scale-95 transition"
        >
        ...
        {hasConversation && (
          ...
          >
            <Link
              to="/pricing"
              aria-label="Get Plus"
              className="h-11 w-11 inline-flex items-center justify-center text-foreground active:scale-95 transition"
            >
